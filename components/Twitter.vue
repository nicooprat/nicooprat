  ...
  <div class="mx-auto max-w-5xl pt-[1px] px-8 space-y-16">
    <Columns :columns="3" class="-mx-4 -my-8">
      <div v-for="(item) in items" :key="item.id" class="relative rounded-xl bg-gradient-to-b from-blue-300 to-blue-400 shadow-lg shadow-blue-600/25 p-6 space-y-3 bg-blue-500 text-blue-900 self-start mx-4 my-8">
        <img loading="lazy" src="https://avatars.githubusercontent.com/u/645641?v=4" alt="Nico Prat Twitter" class="rounded-full w-12 -mt-8 -mr-8 mb-4 ml-4 float-right shadow-md ">
