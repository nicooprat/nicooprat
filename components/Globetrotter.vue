  ...
  <div v-intersection-observer="onIntersectionObserver" class="bg-gradient-to-br from-blue-400 to-blue-600 py-32 px-8">
    <a href="https://www.globetrotter.io/" class="mx-auto max-w-5xl pt-[1px] relative z-0 text-white">
          ...
          <div class="translateX">
            <div class="translateY">
              <svg viewBox="0 0 97.4 160.2">
                <path fill="currentColor" d="M56.7,160.2l-15.3,0c-1.7,0-3.1-1.2-3.1-2.7l-3-19.2c0-1.5,1.4-2.7,3.1-2.7l21.4,0 c1.7,0,3.1,1.2,3.1,2.7l-3.1,19.2C59.7,159,58.4,160.2,56.7,160.2z" />
                <path fill="currentColor" d="M70.8,5.2c-1-0.5-1.9,0.7-1.2,1.6c8.2,8.7,15.6,22.9,15.6,39.9c0,21.5-9.2,41.9-22.3,63.4 c-0.6,1,0.8,2.1,1.6,1.2c18.8-21.8,33-42.2,33-63.8C97.4,28.2,85.4,12.8,70.8,5.2z" />
                <path fill="currentColor" d="M12.3,46.6c0-17,7.2-31.1,15.4-39.7c0.8-0.8-0.2-2.1-1.2-1.6C11.8,12.9,0,28.1,0,47.4 c0,24.2,15.2,43,33.6,63.7c0.8,0.9,2.2-0.2,1.6-1.2C22.4,89.6,12.2,70.6,12.3,46.6z" />
                <path fill="currentColor" d="M48.8,0C33.4,0,20.9,18.8,20.8,47.4S33,97.1,45.9,122.5c2.9,5,3.3,5,5.6,0 c13.2-26,25-49.8,25-75.1C76.6,18.8,64.2,0,48.8,0z" />
              </svg>
            </div>
          </div>
        </div>
      ...
      <video
        ...
        class="rounded-xl shadow-2xl shadow-blue-900 mt-16 max-w-2xl mx-auto"
        loop
        muted
      ></video>

      <h4 class="text-blue-900  font-bold text-center my-16 -mb-16">
